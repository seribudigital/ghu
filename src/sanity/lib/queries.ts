...
export const RECENT_RUMAH_QUERY = groq`* [_type == "property" && category == "Rumah"] | order(_createdAt desc)[0...3] {
  _id,
    title,
    slug,
    category,
...
export const RECENT_TANAH_QUERY = groq`* [_type == "property" && category == "Tanah Kapling"] | order(_createdAt desc)[0...3] {
  _id,
    title,
    slug,
    category,
